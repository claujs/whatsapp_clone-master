...
class _ChatMessageScreenState extends State<ChatMessageScreen> {
  ...
  void initState() {
    ...
    messages = [
      MessageItem('Oi', DateTime.now(), isMine: true),
      MessageItem('Oi', DateTime.now(), isMine: false),
      MessageItem('Oi', DateTime.now(), isMine: true),
      MessageItem('Oi', DateTime.now(), isMine: false),
    ];
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Center(child: CustomTextBoxWidget('Hoje', Colors.blue.shade300)),
          SizedBox(
            height: 16,
          ),
          Center(
            child: CustomTextBoxWidget(
                'A mensagem deste bate-papo está criptografada',
